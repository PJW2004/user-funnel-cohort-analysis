...
**"이번 주 고객 행동 분석 리포트입니다."**

**[Acquisition]** "이번 달 신규 고객이 235명입니다. 지난달 대비 15% 감소했고, 연말 쇼핑 시즌이 끝난 영향으로 보입니다."

**[Activation]** "신규 고객의 첫 주문 평균 금액은 £298입니다. 첫 구매 후 재구매로 이어지는 비율은 72.4%입니다."

**[Retention]** "지난달 코호트의 1개월 후 잔존율이 21.2%입니다. **첫 달에 79%가 이탈**하고 있어서 여기가 가장 큰 구멍입니다. 특히 30일 이내 재구매율은 23.6%에 불과합니다."

**[Revenue]** "이번 달 ARPU(고객당 평균 매출)는 £3,019, AOV(주문당 평균 금액)는 £480입니다."

**[퍼널]** "전체 5,878명 중 재구매 고객은 4,255명(72.4%), 3개월 이상 정기 구매 고객은 3,030명(51.5%)입니다. **1회 구매 → 재구매 단계에서 27.6%가 이탈**하는 것이 가장 큰 병목입니다."

**→ 이 보고를 듣고 의사결정권자가 하는 말:**
- "첫 구매 후 7일 안에 추천 이메일 보내자"
- "상위 23% VIP 고객한테 전용 할인 쿠폰 주자"
- "1월에 연말 시즌 고객 재활성화 캠페인 돌리자"

> **요약**: 이 분석은 **"우리 서비스가 지금 건강한지, 어디가 아픈지"를 매주 체크하는 건강검진표**다.
> 데이터 분석가는 이 건강검진 결과를 보고 "여기가 아프니까 이렇게 고치자"고 제안하는 사람이다.
